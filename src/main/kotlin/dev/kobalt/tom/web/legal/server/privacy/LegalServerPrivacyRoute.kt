...
fun Route.legalServerPrivacyRoute() {
    route(LegalServerPrivacyRepository.pageRoute) {
        get {
            call.respondHtmlContent(
                title = LegalServerPrivacyRepository.pageTitle,
                description = LegalServerPrivacyRepository.pageSubtitle
            ) {
                pageArticle(
                    LegalServerPrivacyRepository.pageTitle,
                    LegalServerPrivacyRepository.pageSubtitle
                ) {
                    pageMarkdown(LegalServerPrivacyRepository.pageContent)
                }
            }
        }
    }
